...
var map;
function initialize() {
      var myLatlng = new google.maps.LatLng(20.4302539,106.1694413);
      var myOptions = {
    zoom: 16,
    center: myLatlng,
...
text= "<b style='color:#00F' " + 
         "style='text-align:center'>Cửa hàng Fashion Cool Mate!<br />" + 
   ...
   var infowindow = new google.maps.InfoWindow(
    ...
    var marker = new google.maps.Marker({
      position: myLatlng, 
      map: map,
      title:"Cửa hàng Fashion Cool here!"
  });
}
</script>
            ...
            <nav>  
                ...
                <div >
                    <section>
                        ...
                        <h2>STORE ADDRESS</h2>
                        <p>
                        <h4>FPT BTEC INTELLATION AND TECHLONOGY<br>

                        Address: Thanh Xuân , trịnh đức bô<br>
                        Phone:   +38 414 6024<br>

                        Email :  cutmeoheo@gmail.com<br>

                        Website : Fashioncoolmate.com<br></h4>
                        </p>
                        ...
                        <p>Việt Nam<br><br>
                              Tel: 0384146024<br>
                              <br>
                              Email: <a href="#">cutmeoheo@gmail.com</a></p>
